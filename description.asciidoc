...
* Okolo 10 dni kalendarzowych na sprawy formalne
...
* Igor wspomina, ze jest opcja leasingu lub podobnego (Volzwagen ma taka opcje)
  ze kozysta sie z samochodu przez dwa lata, a po tym czasie oddaje sie
  samochod do salonu, a nastepnie otrzymuje sie calkowicie nowy.
