...
* Zamontowanie na pok³adzie komputera z modu³em GPS, ODB2, Kamera, pamiecia
  (czarna skrzynka w przypadku wypadku), ewentualnie alco test, czujnik dymu -
  np nie mozna paliæ w samochodzie
...
* Spe³nienie wymogów Ubera dotyczacych kierowcy i samochodu
...
* Modu³ komputera samochodowego moze pos³uzyc do diagnostyki i monitorowania
...
* Jaki przebieg robi samochód non stop eksploatowany rocznie. Mozna zapytaæ
  Edyty Szwagra, który dorabia sie na Uberze w ten sposób. Mrówy research da³
  nam informacje mniej wiecej 15 km na godzine.
* Forma zatrudnienia jest istotna. Nalezy sprawdziæ, przyk³adem jest strona http://poradnik.wfirma.pl/-umowa-zlecenie-a-umowa-o-dzielo
